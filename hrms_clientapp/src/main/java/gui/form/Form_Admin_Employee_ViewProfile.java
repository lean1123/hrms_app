...
public class Form_Admin_Employee_ViewProfile extends JPanel {
	public Form_Admin_Employee_ViewProfile(int id) {
	...
	private void initComponents(int id) {
		...
		lblReturn.setIcon(new ImageIcon(Form_Admin_Employee_ViewProfile.class.getResource("/gui/icon/icons8-return-16.png")));
...
//        card4 = new gui.component.Card();
		...
		lbPath.setText("Employees/View Profile");
		...
		lblDepartment1.setForeground(Color.GRAY);
		lblDepartment1.setFont(new Font("SansSerif", Font.BOLD, 12));
		...
		lblPosition1.setForeground(Color.GRAY);
		lblPosition1.setFont(new Font("SansSerif", Font.BOLD, 12));
		...
		lblStartdate1 = new JLabel("Offical Start Date");
		lblStartdate1.setForeground(Color.GRAY);
		lblStartdate1.setFont(new Font("SansSerif", Font.BOLD, 12));
		...
		lblsalary1 = new JLabel("Salary Aggrement");
		lblsalary1.setForeground(Color.GRAY);
		lblsalary1.setFont(new Font("SansSerif", Font.BOLD, 12));
		...
		lblAllownce = new JLabel("1.000.000 VND");
		lblAllownce.setForeground(Color.DARK_GRAY);
		lblAllownce.setFont(new Font("SansSerif", Font.BOLD, 12));
			...
			gl_pn_info.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_pn_info.createSequentialGroup()
					...
					.addGroup(gl_pn_info.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pn_info.createSequentialGroup()
							.addComponent(lblStartdate1, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblStartdate, GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE))
						.addGroup(gl_pn_info.createSequentialGroup()
							.addComponent(lblPosition1, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblPosition, GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE))
						.addGroup(gl_pn_info.createSequentialGroup()
							.addComponent(lblDepartment1, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
				...
				.addGroup(gl_pn_info.createSequentialGroup()
					...
					.addGroup(gl_pn_info.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pn_info.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(lblAllownce, GroupLayout.PREFERRED_SIZE, 471, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pn_info.createSequentialGroup()
							.addComponent(lblsalary1, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_pn_info.setVerticalGroup(
			gl_pn_info.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pn_info.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pn_info.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblDepartment1, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblDepartment, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pn_info.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblPosition1, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblPosition, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pn_info.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblStartdate1, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
					...
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_pn_info.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblsalary1, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
					...
					.addGroup(gl_pn_info.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(lblAllownce, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
		...
		layout.setVerticalGroup(
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addComponent(pn_info, GroupLayout.DEFAULT_SIZE, 580, Short.MAX_VALUE)
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 292, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		
		lblEmailLable = new JLabel("Email");
		lblEmailLable.setForeground(Color.GRAY);
		lblEmailLable.setFont(new Font("SansSerif", Font.BOLD, 12));
		
		lblEmail = new JLabel("davidbeckham@gmail.com");
		lblEmail.setForeground(Color.DARK_GRAY);
		lblEmail.setFont(new Font("SansSerif", Font.BOLD, 12));
		
		lblMobileNoLable = new JLabel("Mobile no.");
		lblMobileNoLable.setForeground(Color.GRAY);
		lblMobileNoLable.setFont(new Font("SansSerif", Font.BOLD, 12));
...
//		pic.setIcon(icon);
		...
		imageAvatar.setIcon(new ImageIcon(Form_Admin_Employee_ViewProfile.class.getResource("/gui/icon/profile.jpg")));
		
		lblEdit = new JLabel("");
		lblEdit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(new Form_Admin_Employee_Edit(id));
			}
		});
		lblEdit.setToolTipText("Edit");
		lblEdit.setHorizontalAlignment(SwingConstants.CENTER);
		lblEdit.setIcon(new ImageIcon(Form_Admin_Employee_ViewProfile.class.getResource("/gui/icon/edit.png")));
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(gl_panel.createSequentialGroup()
									.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(lblMobileNoLable, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 76, GroupLayout.PREFERRED_SIZE)
										.addComponent(lblEmailLable, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 76, GroupLayout.PREFERRED_SIZE))
									.addPreferredGap(ComponentPlacement.RELATED)
									.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
			...
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(lblEmailLable, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblMobileNo, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblMobileNoLable, GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
...
//		}
	...
	private void uploadDataToForm(int id) throws RemoteException, MalformedURLException {
		...
		lblAllownce.setText(decimalFormat.format(employee.getAggrementInfo().getAllowance()));
...
//    private gui.component.Card card4;
	...
	private JLabel lblMobileNoLable;
	...
	private JLabel lblsalary1;
	private JLabel lblSalary;
	private JLabel lblHomeAddress_6;
	private JLabel lblAllownce;
