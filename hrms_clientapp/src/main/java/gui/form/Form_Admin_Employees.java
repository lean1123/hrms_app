...
public class Form_Admin_Employees extends JPanel{
	private static List<Employee> list=null;
	
	public Form_Admin_Employees() {
        initComponents();
    ...
    private void initTableData() {
        ...
        //table1.addRow(new ModelEmployee1("00012",new ImageIcon(getClass().getResource("/gui/icon/profile.jpg")), "Jonh", "Apple","Dev","Dev","Active").toRowTable());
        //table1.addRow(new ModelEmployee1("00013",new ImageIcon(getClass().getResource("/gui/icon/profile1.jpg")), "Dara", "Apple","Dev","Dev","Active").toRowTable());
        
        try {
			list = Application.employeeDao.findAll();
        ...
        for (Employee employee : list) {
        	...
        	table1.addRow(new Object[] {employee.getId(), new ModelProfile(icon, employee.getFullName()),employee.isSex()?"Male":"Female",dateTimeFormatter.format(employee.getDob()), employee.getDepartment().getName(), employee.getRole().name()});
		}
...
//        card4 = new gui.component.Card();
        ...
        btnAdd.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
        		Application.main.showForm(new Form_Admin_Employee_AddNew());
        	}
        });
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID","Name", "Gender", "Date Of Birth", "Department", "Position",""
            }
        ) {
        ...
        event = new TableActionEvent() {
			...
			public void onView(int row) {
				...
				Application.main.showForm(new Form_Admin_Employee_ViewProfile(id));
			}
			...
			public void onDelete(int row) {
				...
				try {
					...
					else Application.showMessageError("Faild");
				} catch (RemoteException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
        ...
        txtSearch.setToolTipText("Input name employee");
