...
public class Message extends javax.swing.JDialog {
    ...
    public Message(java.awt.Frame parent, boolean modal, String type) {
        super(parent, modal);
        initComponents(type);
        if (type.equals("ERROR")) {
        	lbIcon.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.ERROR, 60, new Color(254, 86, 96), new Color(113, 74, 67)));
        }
        if (type.equals("WARNING")) {
        	lbIcon.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.WARNING, 60, new Color(255, 255, 0), new Color(153, 153, 0)));
        }
        if (type.equals("SUCCESS")) {
        	lbIcon.setIcon(IconFontSwing.buildIcon(GoogleMaterialDesignIcons.CHECK, 60, new Color(0, 255, 0), new Color(0, 153, 0)));
        }
        setOpacity(0f);
