...
public class Form_Employee_MyProfile extends JPanel {
	public Form_Employee_MyProfile(int id) {
...
//		pic.setIcon(icon);
		...
		imageAvatar.setIcon(new ImageIcon(Form_Employee_MyProfile.class.getResource("/gui/icon/profile.jpg")));
		
		lblEdit = new JLabel("");
		lblEdit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(new Form_Employee_EditMyProfile(id));
			}
		});
		lblEdit.setToolTipText("Edit");
		lblEdit.setHorizontalAlignment(SwingConstants.CENTER);
		lblEdit.setIcon(new ImageIcon(Form_Employee_MyProfile.class.getResource("/gui/icon/edit.png")));
