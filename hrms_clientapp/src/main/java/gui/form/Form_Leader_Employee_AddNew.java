...
public class Form_Leader_Employee_AddNew extends JPanel {
	...
	private void initComponents() {
		...
		jLabel1.setText("My Department/Employees/Add new employee");
		...
		cmbPosition = new JComboBox(new String[] { "EMPLOYEE" });
		...
		layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(layout.createSequentialGroup()
				...
				.addGroup(layout.createParallelGroup(Alignment.TRAILING).addGroup(layout.createSequentialGroup()
						...
						.addPreferredGap(ComponentPlacement.RELATED, 640, Short.MAX_VALUE).addComponent(lblReturn))
