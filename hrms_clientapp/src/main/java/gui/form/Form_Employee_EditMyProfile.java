...
public class Form_Employee_EditMyProfile extends JPanel{
	public Form_Employee_EditMyProfile(int id) {
	...
	private void initComponents(int id) {
		...
		lblReturn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(Application.form_Employee_MyProfile);
			}
		});
		...
		jLabel1.setText("My Profile/Edit My Profile");
		...
		try {
			departmentName = Application.employeeDao.findById(id).getDepartment().getName();
		} catch (RemoteException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Application.main.showForm(Application.form_Leader_MyProfile);
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (updateEmployee(id)) {
						Application.main.showForm(Application.form_Employee_MyProfile);
						Form_Employee_MyProfile.uploadDataToForm(id);
