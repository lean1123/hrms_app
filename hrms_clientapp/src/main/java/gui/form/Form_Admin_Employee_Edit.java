...
public class Form_Admin_Employee_Edit extends JPanel{
	public Form_Admin_Employee_Edit(int id) {
	...
	private void initComponents(int id) {
		...
		lblReturn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(Application.form_Admin_Employees);
		...
		jLabel1.setText("Employees/Edit employee");
		...
		cmbPosition = new JComboBox(new String[] {"LEADER","EMPLOYEE"});
		...
		try {
			departments = Application.departmentDao.findAll();
		...
		for (Department department : departments) {
			listDepartmentName.add(department.getName());
		}
		
		cmbDepartment = new JComboBox(listDepartmentName.toArray());
		...
		gl_pnRight.setHorizontalGroup(
			gl_pnRight.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_pnRight.createSequentialGroup()
					.addContainerGap()
					.addComponent(cmbPosition, 0, 462, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnRight.createSequentialGroup()
					.addGap(10)
				...
				.addGroup(gl_pnRight.createSequentialGroup()
					.addContainerGap()
					.addComponent(cmbDepartment, 0, 462, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnRight.createSequentialGroup()
					.addContainerGap()
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (updateEmployee(id)) {
						Application.main.showForm(Application.form_Admin_Employees);
						Form_Admin_Employees.reloadTableData();
						Application.showMessageSucces("Update employee succes");
					}
					else Application.showMessageError("Update employee failed!");
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
		...
		gl_pnRight_1.setHorizontalGroup(
			gl_pnRight_1.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_pnRight_1.createSequentialGroup()
					...
					.addGroup(gl_pnRight_1.createParallelGroup(Alignment.LEADING)
						.addComponent(lblNewLabel_4_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNewLabel_5_1, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(310, Short.MAX_VALUE))
				.addGroup(gl_pnRight_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtSalaryAgg, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(Alignment.LEADING, gl_pnRight_1.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtAllowance, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_pnRight_1.setVerticalGroup(
			gl_pnRight_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnRight_1.createSequentialGroup()
		...
		gl_pnRight_2.setHorizontalGroup(
			gl_pnRight_2.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_pnRight_2.createSequentialGroup()
					...
					.addGroup(gl_pnRight_2.createParallelGroup(Alignment.LEADING)
						.addComponent(lblNewLabel_4_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNewLabel_5_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(310, Short.MAX_VALUE))
				.addGroup(gl_pnRight_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtUsername, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(Alignment.LEADING, gl_pnRight_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtPassword, GroupLayout.DEFAULT_SIZE, 462, Short.MAX_VALUE)
					.addContainerGap())
		);
		gl_pnRight_2.setVerticalGroup(
			gl_pnRight_2.createParallelGroup(Alignment.LEADING)
			...
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(layout.createSequentialGroup()
							.addComponent(pnLeft, GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE)
							.addGap(18)
							.addGroup(layout.createParallelGroup(Alignment.TRAILING)
								.addComponent(pnRight, GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
								.addComponent(pnRight_1, GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
								.addComponent(pnRight_2, GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)))
						.addGroup(layout.createSequentialGroup()
			...
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
							.addComponent(pnRight, GroupLayout.PREFERRED_SIZE, 203, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(pnRight_1, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
		...
		gl_pnLeft.setHorizontalGroup(
			gl_pnLeft.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtFullName, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(cmbGender, 0, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtDateOfBirth, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtEmail, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
				...
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtMobile, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblNewLabel_2_1_8, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(321, Short.MAX_VALUE))
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
					.addComponent(txtHomeAddress, GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE)
					.addContainerGap())
				.addGroup(gl_pnLeft.createSequentialGroup()
					.addContainerGap()
	...
	private void uploadDataToForm(int id) throws RemoteException {
		...
		//cmbDepartment.setModel(new DefaultComboBoxModel<>(new String[] {employee.getDepartment().getName()}));
		cmbDepartment.setSelectedIndex(employee.getDepartment().getId()-1);
		Department departmentCMB = null;
		try {
			 departmentCMB = Application.departmentDao.findByName(employee.getDepartment().getName()).get(0);
		} catch (RemoteException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		...
		try {
			 leader = Application.employeeDao.getLeader(departmentCMB.getId());
		} catch (RemoteException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		if (leader!=null) {
			cmbPosition.setModel(new DefaultComboBoxModel<>( new String[] {"EMPLOYEE"}));
		}
		else cmbPosition.setModel(new DefaultComboBoxModel<>( new String[] {"LEADER","EMPLOYEE"}));
	}
	...
	private boolean updateEmployee(int id) throws RemoteException {
        ...
        if (!department.equals(employee.getDepartment())) employee.setDepartment(department);
        ...
        if (!urlPhoto.equals("") || !urlPhoto.equals(employee.getAvatar())) {
			CloudinaryUploader cloudinaryUploader = new CloudinaryUploader(employee.getId(),urlPhoto);
			cloudinaryUploader.start();
		}
		return true;
	}
