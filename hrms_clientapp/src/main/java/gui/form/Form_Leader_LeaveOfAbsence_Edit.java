...
public class Form_Leader_LeaveOfAbsence_Edit extends JPanel {
	public Form_Leader_LeaveOfAbsence_Edit(int idRest) {
	...
	private void initComponents(int idRest) {
		...
		lblReturn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(Application.form_Leader_LeavesOfAbsenca);
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (editLeaveOfAbsence(idRest)) {
						Application.main.showForm(Application.form_Leader_LeavesOfAbsenca);
						Form_Leader_LeavesOfAbsenca.reloadTable();
						
						if (Form_Leader_LeavesOfAbsenca.getTable1().isEditing()) {
							Form_Leader_LeavesOfAbsenca.getTable1().getCellEditor().stopCellEditing();
						}
