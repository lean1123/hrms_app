...
public class Form_Admin_LeavesOfAbsence extends JPanel{
	private static List<RestAllowed> list = null;
	public Form_Admin_LeavesOfAbsence() {
        initComponents();
        getTable1().fixTable(jScrollPane1);
        setOpaque(false);
        initData();
    }
    ...
    public static void reloadTable() {
    	DefaultTableModel dm = (DefaultTableModel) getTable1().getModel();
...
//        card4 = new gui.component.Card();
        ...
        setTable1(new gui.swing.table.Table());
        ...
        getTable1().setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        event = new TableActionEvent() {
			...
			public void onEdit(int row) {
				...
				int idRest = (int) getTable1().getValueAt(row, 0);
				Application.main.showForm(new Form_Admin_LeaveOfAbsence_Edit(idRest));
			}
        ...
        jScrollPane1.setViewportView(getTable1());
        if (getTable1().getColumnModel().getColumnCount() > 0) {
            getTable1().getColumnModel().getColumn(0).setPreferredWidth(150);
        }
        ...
        txtSearch.setToolTipText("input id employee");
	...
	public static void setTable1(gui.swing.table.Table table1) {
		Form_Admin_LeavesOfAbsence.table1 = table1;
	}
