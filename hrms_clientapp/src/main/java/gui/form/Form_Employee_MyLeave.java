...
public class Form_Employee_MyLeave extends JPanel{
	private static List<RestAllowed> list = null;
	public Form_Employee_MyLeave() {
        initComponents();
    ...
    public static void reloadTable() {
    	...
    	try {
			list = Application.restAllowedDao.findByEmployee(Application.idUserLogin);
        ...
        for (RestAllowed restAllowed : list) {
        	...
        	table1.addRow(new Object[] {restAllowed.getEmployee().getFullName(),restAllowed.getReason(),dateTimeFormatter.format(restAllowed.getFromDate()), dateTimeFormatter.format(restAllowed.getToDate()), dateTimeFormatter.format(restAllowed.getReturnDate()), restAllowed.isAllowedStatus()?"Approved":"Waiting"});
		}
    }
...
//        card4 = new gui.component.Card();
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee","Description", "Leave From", "Leave To", "Return Date", "Status"
            }
        ) {
        ...
        btnAdd.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Application.main.showForm(new Form_Employee_AddLeave());
        		
        	}
        });
        btnAdd.setIcon(new ImageIcon(Form_Employee_MyLeave.class.getResource("/gui/icon/add.png")));
