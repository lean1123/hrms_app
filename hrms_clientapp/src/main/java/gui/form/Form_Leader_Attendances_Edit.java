...
public class Form_Leader_Attendances_Edit extends JPanel{
	public Form_Leader_Attendances_Edit(int emID, LocalDate atDate) {
	...
	private void initComponents() {
		...
		lblReturn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(Application.form_Leader_Attendances);
			}
		});
		...
		jLabel1.setText("My Department/Attendances / Edit Attendances");
			...
			layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(layout.createSequentialGroup()
							.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 377, GroupLayout.PREFERRED_SIZE)
