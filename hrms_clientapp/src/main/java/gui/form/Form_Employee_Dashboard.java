...
public class Form_Employee_Dashboard extends javax.swing.JPanel {

    public Form_Employee_Dashboard() {
        initComponents();
    ...
    private void initCardData() {
        Icon icon1 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.TIMER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card1.setData(new ModelCard("ATTENDANCES", "Late Arrivals", "Early Departures",5,6, icon1));
        ...
        card2.setData1(new ModelCardEmpl("PRESENT SCHEDULE", "Time", "Rest Days", "08:00 Am - 05:00 PM", "Sunday, Saturday", icon2));
