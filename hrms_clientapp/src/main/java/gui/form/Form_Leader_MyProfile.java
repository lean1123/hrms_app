...
public class Form_Leader_MyProfile extends JPanel {
	public Form_Leader_MyProfile(int id) {
				...
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(layout.createSequentialGroup()
							...
							.addGap(18)
							.addComponent(pn_info, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
					.addContainerGap())
		);
		layout.setVerticalGroup(
			layout.createParallelGroup(Alignment.LEADING)
				.addGroup(layout.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addComponent(pn_info, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//		pic.setIcon(icon);
		...
		imageAvatar.setIcon(new ImageIcon(Form_Leader_MyProfile.class.getResource("/gui/icon/profile.jpg")));
		
		lblEdit = new JLabel("");
		lblEdit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Application.main.showForm(new Form_Leader_EditMyProfile(id));
			}
		});
		lblEdit.setToolTipText("Edit");
		lblEdit.setHorizontalAlignment(SwingConstants.CENTER);
		lblEdit.setIcon(new ImageIcon(Form_Leader_MyProfile.class.getResource("/gui/icon/edit.png")));
	...
	public static void uploadDataToForm(int id) throws RemoteException, MalformedURLException {
    	...
    	try {
			...
			// TODO Auto-generated catch block
			icon = new ImageIcon(Form_Leader_MyProfile.class.getResource("/gui/icon/noimage.jpg"));
		}
...
//    private gui.component.Card card4;
	...
	private static JLabel lblSalary;
	private JLabel lblHomeAddress_6;
	private static JLabel lblAllowance;
